...
main() {
    ...
    docker volume create portainer_data
    curl -s https://raw.githubusercontent.com/SamuelGTurner/HomeLab/refs/heads/dev/shared/container-management/docker-compose.yml?token=GHSAT0AAAAAAC3K2YL6USJYDXENITT6HZ5OZ6M3RBQ | docker compose -f - up -d
