...
main() {
    ...
    export DOCKERDIR
    export DOMAINNAME
    curl -s "https://raw.githubusercontent.com/SamuelGTurner/HomeLab/refs/heads/${1:-main}/container-management/portainer-host/docker-compose.yml" | docker compose -f - up -d --pull always
