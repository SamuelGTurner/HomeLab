...
main() {
    ...
    export DOCKERDIR
    export DOMAINNAME
    curl -s https://raw.githubusercontent.com/SamuelGTurner/HomeLab/refs/heads/main/container-management/portainer-host/docker-compose.yml | docker compose -f - up -d --pull always
